   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Text:    AABAACAADAABAABAAABCAABAABA\n",
      "Pattern: AABAA\n",
      "\n",
      "Naive  -> Matches at: [0, 9, 12, 20], Comparisons: 55\n",
      "KMP    -> Matches at: [0, 9, 12, 20], Comparisons: 31\n",
      "RK     -> Matches at: [0, 9, 12, 20], Comparisons: 20\n",
      "\n",
      "     Pattern      Naive        KMP         RK\n",
      "--------------------------------------------------\n",
      "          AB      12495      10000       1270\n",
      "        ABCD      13297      10000        243\n",
      "      ABCDAB      13346      10010        174\n",
      "    ABCDABCD      13346      10011        154\n"
     ]
    }
   ],
   "source": [
